...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        <a href="export.php?<?= http_build_query(['search' => $search, 'faculty_id' => $faculty_id]) ?>" class="btn btn-outline-secondary"><i class="bi bi-file-earmark-spreadsheet"></i> Export CSV</a>
