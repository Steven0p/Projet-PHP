...
?>
<h1 class="h3 mb-4">Modifier la salle</h1>
...
<form method="post" action="">
    ...
    <div class="mb-3"><label class="form-label">Capacité</label><input type="number" min="1" name="capacite" class="form-control" value="<?= e((string) ($data['capacite'] ?? '')) ?>"></div>
    <div class="mb-3">
