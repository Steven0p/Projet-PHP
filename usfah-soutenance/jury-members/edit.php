...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    verify_csrf();
    foreach (['first_name', 'last_name', 'email', 'telephone', 'specialite', 'institution', 'fonction'] as $field) {
...
$page_title = 'Modifier un membre de jury';
require __DIR__ . '/../includes/header.php';
?>
<h1 class="h3 mb-4">Modifier le membre de jury</h1>
